...
class _SignInState extends State<SignIn> {
  ...
  SignInModel registerModel = SignInModel();
  ...
  // void _signIn() async {
  //   try {
  //     final signInResponse = await ApiIntegration.sendPostRequest(
  //       emailController.text,
  //       passController.text,
  //     );
  //     Navigator.push(context, MaterialPageRoute(builder: (context)=>HomePage()));
  //     // Use the signInResponse as needed, e.g., to navigate to the home page.
  //     print('Sign-in successful. Token: ${signInResponse.token}');
...
//         Uri.parse("https://apilomda.fitowiki.com/api/login"),
...
// }
          ...
          children: <Widget>[
            ...
            Expanded(
              child: TextFormField(
                ...
                validator: (value) {
                  if (value!.isEmpty) {
                    return "Gmail address cannot be empty";
                  }
                  return null;
                },
                onChanged: (value) {
              ...
              child: TextFormField(
                ...
                validator: (value) {
                  if (value!.isEmpty) {
                    ...
                    return "Password length should be alt east 6";
                  }
                },
              ),
            ),
  ...
  Widget buildSkip() {
    return ElevatedButton(
      ...
      style: ButtonStyle(
        backgroundColor:
            MaterialStateColor.resolveWith((states) => const Color(0xFF4DA1B0)),
      ),
      ...
      builder: (context, provider, child) {
        return GestureDetector(
          ...
          child: Container(
            ...
            child: provider.signingIn?const Center(child: CircularProgressIndicator()): Text(
              'Sign in',
              style: GoogleFonts.inter(
                fontSize: 16.0,
                color: Colors.white,
